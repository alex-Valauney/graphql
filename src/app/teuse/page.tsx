...
async function exeGraphQLQuery(query: string, variables: Record<string, any> = {}) {
...
function getXPPoints(transactions: any[]) {
  let total = 0;
...
function getAuditsPerMonth(audits: any[]) {
    ...
    <main className="min-h-screen bg-green-100 flex flex-col items-center justify-between">
      ...
      <div className="w-full flex justify-center mt-20">
        {user && (
          <div className="border p-16 bg-white rounded shadow-md flex flex-col items-center w-[800px]">
            {user.avatarUrl && (
              <img src={user.avatarUrl} alt="avatar" className="w-40 h-40 rounded-full mb-10" />
            )}
      ...
      <div className="w-full flex justify-between items-end px-40 pb-24 mt-auto">
        <div className="w-[800px]">
          <h2 className="text-2xl font-bold mb-6 text-center">Courbe d'XP cursus</h2>
